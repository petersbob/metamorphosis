...
worldshift.Preloader.prototype = {
	...
	//------------------//
	//---------------sprite parts---------------//
	this.load.spritesheet('torso', 'images/playersprites/Torso.png', 41, 49);
	this.load.spritesheet('back_arm', 'images/playersprites/Back_arm.png', 27, 24);
	this.load.spritesheet('front_arm', 'images/playersprites/Front_arm.png', 27, 24);
	this.load.spritesheet('back_leg', 'images/playersprites/Back_leg.png', 45, 25);
	this.load.spritesheet('front_leg', 'images/playersprites/Front_leg.png', 43, 22);
	this.load.spritesheet('head', 'images/playersprites/headspritesheet.png', 96.22, 96);
